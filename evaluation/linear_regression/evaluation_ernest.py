...
class FixedRateWorkloadErnest(object):
    def __init__(self, eval_config):
        ...
        cmd = 'python3 inference/linear_regression/inference_ernest.py {} {} {} &'.format(self.train_config_path, self.eval_config.pod_filter, len(self.eval_config.services))
        print(cmd)
        os.system(cmd)
    ...
    def save_results(self, res):
        ...
        # Save results.
        save_path = os.path.join('evaluation', 'results', self.application, self.name, '{}_lr.pk'.format(self.bandit_policy))
