...
class FixedRateWorkloadErnest(object):
    def __init__(self, eval_config):
        ...
        cmd = 'python3 inference/bayesian_optimization/inference_ernest.py {} {} {} &'.format(self.train_config_path, self.eval_config.pod_filter, len(self.eval_config.services))
        os.system(cmd)
    ...
    def run(self):
        ...
        os.system('pkill -f inference_ernest')
    ...
    def save_results(self, res):
        ...
        # Save results.
        save_path = os.path.join('evaluation', 'results', self.application, self.name, '{}_ernest.pk'.format(self.bandit_policy))
