...
class FixedRateWorkloadDQN(object):
    def __init__(self, eval_config):
        ...
        cmd = 'python3 inference/deep_q_network/inference_dqn.py {} {} {} &'.format(self.train_config_path, self.eval_config.pod_filter, len(self.eval_config.services))
        print(cmd)
        os.system(cmd)
    ...
    def run(self):
        ...
        os.system('pkill -f inference_dqn')
    ...
    def save_results(self, res):
        ...
        # Save results.
        save_path = os.path.join('evaluation', 'results', self.application, self.name, '{}_dqn.pk'.format(self.bandit_policy))
